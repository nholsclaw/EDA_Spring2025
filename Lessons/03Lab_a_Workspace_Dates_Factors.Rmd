...
filenames <- dir(here('Data','Raw'),pattern = ("*.csv")) # dir = directory, files in those folders that are .csv 
print(filenames)
```
...
sites$dow <- factor(sites$dow, levels=c("1","2","3","4","5","6","7")) #Or... factor(sites$dow, as.character(seq(1,7))
