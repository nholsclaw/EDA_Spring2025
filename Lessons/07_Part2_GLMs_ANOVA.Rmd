...
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_040"]) # not normal
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_041"]) # not normal
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_046"]) # normal
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_047"]) # not normal
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_051"]) # not normal
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_057"]) # normal
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_058"]) # not normal
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_061"]) # not normal
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_062"]) # not normal
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_063"]) # not normal
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_064"]) # not normal
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_067"]) # normal
