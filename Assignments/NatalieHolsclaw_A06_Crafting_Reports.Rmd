...
```{r, echo = FALSE, warning = FALSE, fig.cap = "Ozone Levels in 2018", fig.align='left', fig.height=3,fig.width=6}
epa_data %>% 
  filter(Year == 2018) %>% 
  ggplot()+
  geom_boxplot(aes(x = as.factor(Month), y = Ozone), fill = "darkseagreen")+
  theme_bw()+
  labs(x = "Month", y = expression(paste("Ozone ", "\u00b5",g/m^3)))+
  theme(legend.position = "none")
```

```{r, echo = FALSE, warning = FALSE, fig.cap = "Ozone Levels in 2019", fig.align='left', fig.height=3,fig.width=6}
epa_data %>% 
  filter(Year == 2019) %>% 
  ggplot()+
  geom_boxplot(aes(x = as.factor(Month), y = Ozone), fill = "skyblue")+
  theme_bw()+
  labs(x = "Month", y = expression(paste("Ozone ", "\u00b5",g/m^3)))+
  theme(legend.position = "none")
```
...
## Git Repository
[Natalie's GitHub](https://github.com/nholsclaw/EDA_Spring2025)